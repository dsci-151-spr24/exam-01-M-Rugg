...
call the dataset
mutate to create a time interval variable
  use if then statements to determine which braket the flight belongs in
create a new variable? (not saved just for math output)
