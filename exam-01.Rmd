...
flights <- 
  ...
  mutate(arrival = if_else(dep_delay > 0, "delayed", "ontime")) #%>%    # creates a variable to store whether the flight has been delayed or not
...
delays_table <- 
  table(flights$time_interval, flights$arrival)  #creates a table of counts to store the data
